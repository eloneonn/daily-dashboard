        ...
        <div className='bike-container'>
            ...
            <table>
                <tbody>
                    <tr>
                        <td>Pernajantie: </td>
                        <td className={`bike-number ${bikes.pernaja === 1 && 'caution-bike'} ${!bikes.pernaja && 'no-bike'}`}>{bikes.pernaja}</td>
                    </tr>
                    <tr>
                        <td>Hollolantie: </td>
                        <td className={`bike-number ${bikes.hollola === 1 && 'caution-bike'} ${!bikes.hollola && 'no-bike'}`}>{bikes.hollola}</td>
                    </tr>
                    <tr>
                        <td>Gebhardinaukio: </td>
                        <td className={`bike-number ${bikes.gebhard === 1 && 'caution-bike'} ${!bikes.gebhard && 'no-bike'}`}>{bikes.gebhard}</td>
                    </tr>
                </tbody>
            </table>
        </div>
